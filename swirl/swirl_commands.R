...
| any time by pressing the Esc key. If you are already at
| the prompt, type bye() to exit and save your progress.
| When you exit properly, you'll see a short message
...
install_from_swirl("R Programming", mirror='github')

install_course_zip("~/Software/swirl_courses-master.zip", multi=T, which_course = "R Programming")
